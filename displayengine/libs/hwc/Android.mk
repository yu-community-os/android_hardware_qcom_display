...
LOCAL_C_INCLUDES              := hardware/qcom/display/$(QCOM_HARDWARE_VARIANT)/displayengine/include/ \
                                 hardware/qcom/display/$(QCOM_HARDWARE_VARIANT)/libgralloc/ \
                                 hardware/qcom/display/$(QCOM_HARDWARE_VARIANT)/libqservice/ \
                                 hardware/qcom/display/$(QCOM_HARDWARE_VARIANT)/libqdutils/
